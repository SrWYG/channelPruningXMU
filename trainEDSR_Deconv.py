...
from xmumodel.edsr_deconv_nv_prune_v2 import EDSR_P
...
def main(_):
    ...
    #print("========================"+FLAGS.prune) 
    if(FLAGS.prune):
        network = EDSR_P(FLAGS.layers, FLAGS.featuresize, FLAGS.scale,FLAGS.channels, FLAGS.channels, prunedlist, FLAGS.prunesize)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--savedir",default='prune_ckpt/pruned/v1_8')
    parser.add_argument("--logdir", default='log/pruned/v1_8')
    parser.add_argument("--reusedir",default='prune_ckpt/futune/v1_4')
    ...
    parser.add_argument("--prunedlist_path", default="prune_ckpt/pruned/v1_4/prunedlist")
    ...
    parser.add_argument("--prunesize", default=56)
