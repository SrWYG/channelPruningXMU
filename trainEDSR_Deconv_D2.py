...
from xmumodel.edsr_d2 import EDSR_D
...
def main(_):
    ...
    #print("========================"+FLAGS.prune) 
    if(FLAGS.prune):
        network = EDSR_D(FLAGS.layers, FLAGS.featuresize, FLAGS.scale,FLAGS.channels, FLAGS.channels, prunedlist, FLAGS.prunesize)
    else:
    ...
    network.train(FLAGS.batchsize, FLAGS.iterations, FLAGS.lr_init, FLAGS.lr_decay, FLAGS.decay_every,
                  FLAGS.savedir, False, FLAGS.reusedir, 500, log_dir=FLAGS.logdir)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--savedir",default='prune_ckpt/test_88')
    parser.add_argument("--logdir", default='log/test_88')
    parser.add_argument("--reusedir",default='prune_ckpt/pruned/v1_24')
    ...
    parser.add_argument("--prunedlist_path", default="prune_ckpt/pr_d2/v1_88/prunedlist")
