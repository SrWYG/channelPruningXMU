...
if __name__ == '__main__':
    ...
    parser.add_argument("--valid_groundtruthdir", default='/notebooks/data/data/DIV2K/DIV2K_valid_HR')
    ...
    parser.add_argument("--savedir",default='fine_ckpt/v2_64')
    parser.add_argument("--logdir", default='log/fine_tuning/v2_64')
    ...
    parser.add_argument("--iterations",default=1100,type=int)
